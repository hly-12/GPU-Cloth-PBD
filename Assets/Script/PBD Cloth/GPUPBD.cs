...
public class GPUPBD : MonoBehaviour
{
    ...
    public int workGroupSize = 1024; // TODO: figure out what the best value for this is
    ...
    private void CreateBackSide()
    {
        ...
        if (GetComponent<SkinnedMeshRenderer>())
        {
            newCloth.AddComponent<SkinnedMeshRenderer>();
            newCloth.GetComponent<SkinnedMeshRenderer>().material = GetComponent<SkinnedMeshRenderer>().material;
        }
        ...
        if (GetComponent<SkinnedMeshRenderer>())
        {
            newCloth.GetComponent<SkinnedMeshRenderer>().sharedMesh = reverseMesh;
        }
